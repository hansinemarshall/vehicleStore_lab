...
public class VehicleStore {
    ...
    public static void main(String[] args) {
        ...
        Speedboat speedboat1 = new Speedboat(50, 75,
                new Product("Titanic", 1000,5),
                "Flat Bottom", new Motor(100,70));
        ...
        Kayak kayak1 = new Kayak(30,10, new Product("Boaty McBoatface", 500,2));
        vehicles.add(kayak1);
